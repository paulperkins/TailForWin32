 ...
 * 
 * $Id: XListCtrl.cpp,v 1.2 2003/11/12 08:54:19 paulperkins Exp $
 * 
 */
...
CXListCtrl::CXListCtrl()
{
  ...
  m_cImageList.m_hImageList = NULL;
...
BOOL CXListCtrl::DeleteAllItems()
{
  ...
  // Delete all of the header items.
/*  for (int j=0; j < m_HeaderCtrl.GetItemCount (); j++)
  {    
